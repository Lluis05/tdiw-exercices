...
<body>
    ...
    <div id="page">
        ...
        <div style="grid-area: footer;">   
            <footer>
                <img src="img/campus-e.png" width="100px"  id="logo"/>
